        ...
        <section className="py-20 bg-white">
            <div className="container mx-auto px-4">
                ...
                <div className="text-center mb-16">
                    ...
                    >
                        Handpicked treasures from our exclusive collection
                    </p>
                </div>
                ...
                <div className="text-center">
                    <Link
                        href="/showroom"
                        className="inline-block px-12 py-4 text-sm tracking-[0.2em] uppercase border transition-all duration-300 hover:bg-[#172e3c] hover:text-[#fffff5] hover:border-[#172e3c]"
                        style={{
                            borderColor: '#172e3c',
                            color: '#172e3c'
                        }}
